...
from learna.activations import sigmoid
...
class Model:
    ...
    def compute_cost(self, A2, Y):
        ...
        cost = float(np.squeeze(cost))  # makes sure cost is the dimension we expect. eg., turns [[17]] into 17
    ...
    def fit(self, X, Y, n_h, num_iterations=10000, print_cost=False):
        """
        Arguments:
